...
module SQLite3
  ...
  class IoMethods < FFI::Struct
    layout :i_version, :int,
           ...
           :x_lock, :pointer,
           :x_unlock, :pointer,
           :x_check_reserved_lock, :pointer,
           :x_file_control, :pointer,
           :x_sector_size, :pointer,
           :x_device_characteristics, :pointer,
           :x_shm_map, :pointer,
           :x_shm_lock, :pointer,
  ...
  class Vfs < FFI::Struct
    layout :i_version, :int,
           ...
           :x_delete, :pointer,
           :x_access, :pointer,
           :x_full_pathname, :pointer,
           :x_dl_open, :pointer,
           :x_dl_error, :pointer,
           :x_dl_sym, :pointer,
           :x_dl_close, :pointer,
           :x_randomness, :pointer,
           :x_sleep, :pointer,
           :x_current_time, :pointer,
           :x_get_last_error, :pointer,
           :x_current_time_int64, :pointer,
  ...
  class Module < FFI::Struct
    layout :i_version, :int,
           :x_create, :pointer,
           :x_connect, :pointer,
           :x_best_index, :pointer,
           :x_disconnect, :pointer,
           :x_destroy, :pointer,
           :x_open, :pointer,
           :x_close, :pointer,
           :x_filter, :pointer,
  ...
  class IndexInfo < FFI::Struct
    layout :n_constraint, :int,
           ...
           :n_order_by, :int,
           :a_order_by, IndexOrderby,
           :a_constraint_usage, IndexConstraintUsage,
           :idx_num, :int,
           :idx_str, :string,
  ...
  class MutexMethods < FFI::Struct
    layout :x_mutex_init, :pointer,
           :x_mutex_end, :pointer,
           :x_mutex_alloc, :pointer,
           :x_mutex_free, :pointer,
           :x_mutex_enter, :pointer,
           :x_mutex_try, :pointer,
           :x_mutex_leave, :pointer,
